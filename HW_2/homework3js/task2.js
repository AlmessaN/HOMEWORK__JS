...
if (money < price) {
  ...
  if (change >= 4) {
    ...
    if (answer) {
      document.write("<h1>Дякуємо за покупку лотереї! Бажаємо вам удачі!</h1>");
    } else {
      document.write("<h1>Дякуємо за покупку товару!</h1>");
    }
  } else {
    // Якщо залишок недостатній, не пропонуємо купувати лотерею
    document.write(`<h1>Дякуємо за покупку товару! У вас залишиться ${change} грн.</h1>`);
  }
}
